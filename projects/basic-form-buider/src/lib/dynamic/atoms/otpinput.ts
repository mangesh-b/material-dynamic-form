...
@Component({
  selector: 'app-otpinput-type',
  template: `
        <div [formGroup]="form" id="dy-otpinput-type">
            <input [maxlength]="field.maxLength" [type]="field.type" [min]="0"
    ...
    `,
    styleUrls: ['./otpinput.scss']
})

export class FormOtpInputTypeComponent {
